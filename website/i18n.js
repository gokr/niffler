...
(function () {
  ...
  var CATALOGS = {
    zh: {
      ...
      "qs.test": "# 总线契约测试——26 项契约测试 + 冒烟测试 + Go 测试",
      ...
      "comp.provider.p": "基于 store 的 LLM provider 注册表——add/list/switch/active/remove/export/import，运行时切换后端，订阅制 OAuth 登录并自动轮换令牌",
    ...
    "zh-TW": {
      ...
      "qs.test": "# 匯流排契約測試——26 項契約測試 + 冒煙測試 + Go 測試",
      ...
      "comp.provider.p": "以 store 為基礎的 LLM provider 登錄檔——add/list/switch/active/remove/export/import，執行期間切換後端，訂閱制 OAuth 登入並自動輪換權杖",
