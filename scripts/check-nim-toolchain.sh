...
compiler_dir=$(nim --verbosity:0 --hints:off --eval:'import std/os; doAssert (NimMajor, NimMinor, NimPatch) >= (2, 2, 10), "Nim >= 2.2.10 required"; echo getCurrentCompilerExe().parentDir.parentDir / "compiler"') || fail 'toolchain probe failed'
