...
task all_internal, "Unlocked internal build — invoke through all (or the Makefile)":
  ...
  exec "nim c --hints:off --path:sdk -o:var/bin/recall components/recall/main.nim"
  exec "nim c --hints:off --path:sdk -o:var/bin/compaction components/compaction/main.nim"
  ...
  exec "nim c --hints:off --path:sdk -o:var/bin/fabric-exec components/fabric/executor.nim"
  ...
  exec "cd components/mcp && go build -o ../../var/bin/mcp ."
  exec "cd components/mcp-bridge && go build -o ../../var/bin/mcp-bridge ."
